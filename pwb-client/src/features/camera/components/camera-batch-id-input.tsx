...
function CameraBatchIdInput() {
  const [focused, setFocused] = useState(false);

  const { setbatchId, batchId } = useCameraBatchIdStore((state) => {
    return {
  ...
  return (
    <Box component="form" onSubmit={handleSubmit} miw={700} w="100%">
      <Stack w="100%">
        <TextInput
          label="Batch ID"
...
export default CameraBatchIdInput;
